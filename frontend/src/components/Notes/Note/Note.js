...
import { putRequest, deleteRequest } from '../../../utils/apiRequests.js';
        ...
        <div className="note">
            ...
            <div className="note__body">
                <div className="note__body-head">
                    <textarea value={title} placeholder="Title" onChange={handleTitleChange} onBlur={() => handleUpdateNote('title')} />
                </div>
